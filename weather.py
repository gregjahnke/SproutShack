...
axs[0].set_ylabel('Temperature (ÂºC)')
...
while running:
    try:
        ...
        temperature_fahrenheit_values.append(temperature_fahrenheit)
        humidity_values.append(humidity)
        pressure_values.append(pressure)


        # Plot the data
        for i, (ax, values, label) in enumerate(zip(axs, [temperature_fahrenheit_values, humidity_values, pressure_values], ['Temperature (ÂºF)', 'Humidity (%)', 'Pressure (hPa)'])):
            ax.clear()
